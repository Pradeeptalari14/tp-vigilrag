...
> Streamlit-backed telemetry dashboard pulling from Prometheus and Redis to review search performance weekly.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/vigilrag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-vigilrag.git
cd tp-vigilrag
```
...
```bash
kubectl port-forward deployment/tp-vigilrag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── monitoring_dashboard.py     # Main configuration file
```
...
---
*Generated by [VigilRAG Studio](https://pradeeptalari14.github.io/portfolio/tools/vigilrag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
